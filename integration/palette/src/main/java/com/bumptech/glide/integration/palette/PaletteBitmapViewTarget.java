 ...
 * android.graphics.Bitmap} in an {@link android.widget.ImageView} and additionally set some other
 * view's colors based on colors retrieved from a {@link android.support.v7.graphics.Palette}.
 */
public class PaletteBitmapViewTarget extends ImageViewTarget<PaletteBitmap> {
  ...
  public static final class Builder {
     ...
     * such as background, text color, usually something visual and colorful. Must handle lack of a
     * swatch.
     */
